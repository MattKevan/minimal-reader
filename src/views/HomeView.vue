...
<input type="file" @change="uploadBooks" id="bookInput" multiple style="display: none" />
    ...
    <h1>Library</h1>
      ...
      <div v-if="books.length === 0" class="placeholder"><p><strong>Your library is empty.</strong> Add books by dropping them on this window or clicking the plus icon above.</p><p class="xs">Please note: Books are stored locally in your browser's cache, so clearing your browsing data will also remove your books.</p></div>
